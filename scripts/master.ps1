...
# Create IDs for Site Scripts #
    ...
    $id2 = Add-SPOSiteScript -Title "internbibliotek" -Content $internbibliotek -Description "test #1"
        ...
        #$id3 = Add-SPOSiteScript -Title "logo" -Content $logo -Description "test #1"
    $id4 = Add-SPOSiteScript -Title "theme" -Content $theme -Description "test #1"
...
# Creating an array #
    ...
    $SPOIDArray = ($id1.id, $id2.id, $id3.id, $id4.id)
